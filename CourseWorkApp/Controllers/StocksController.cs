...
namespace CourseWorkApp.Controllers
{
    public class StocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StockId,Name,Price")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StockId,Name,Price")] Stock stock)
        {
            if (id != stock.StockId)
            {
                return NotFound();
